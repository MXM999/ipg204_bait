...
namespace ConsoleApp133
{
    internal class Tester
    {
        ...
        static void InitializeSampleData(UniversityManager university)
        {
            ...
            student1.Courses[0] = "Object Oriented Programming";
            student1.Courses[1] = "Data Structures";

            Student student2 = new Student(2, "Fatima", "Ali", 92.3, "Computer Engineering",
                                          new DateTime(1999, 8, 20), new DateTime(2023, 9, 1), 2, true);
            student2.Courses[0] = "Object Oriented Programming";
            student2.Courses[1] = "Database Systems";

            university.AddStudent(student1);
            university.AddStudent(student2);

            // Add sample teachers
            Teacher teacher1 = new Teacher(101, "Dr. Mohammed", "Al-Khaled", 500000, false);
            teacher1.TeachingCourses[0] = "Object Oriented Programming";
            teacher1.ExtraHours = 10;

            Teacher teacher2 = new Teacher(102, "Dr. Sara", "Hussein", 25000, true);
            teacher2.TeachingCourses[0] = "Database Systems";
